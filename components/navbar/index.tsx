        ...
        <nav className="border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                <Link href="/" className="flex items-center">
                    <Image src="/img/ujl.png" alt="ujl" width={125} height={225} />
                </Link>
                ...
                <div className={`${isColappsed ? "sm-hidden" : "hidden"} w-full md:block md:w-auto`} id="navbar-default">
                    <ul className='flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
                        <li>
                            <Link href="https://ujl.com/" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-standard md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Institucional</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="#" className="py-2 ml-3 pl-3 pr-4 bg-standard text-black font-bold rounded">
